...
class GameCrypto {
  ...
  String encryptJSON(Object toEncrypt) {
    return encryptString(jsonEncode(toEncrypt));
  }
  ...
  dynamic decryptJSON(String cryptText) {
    return jsonDecode(decryptString(cryptText));
  }
